...
import { r as readFile, p as parseKnownFiles, g as getProfileName } from "../smithy__shared-ini-file-loader.mjs";
...
class LoginCredentialsFetcher {
  ...
  async refresh(token) {
    const { SigninClient, CreateOAuth2TokenCommand } = await import("../aws-sdk__nested-clients.mjs").then(function(n) {
      return n.b;
    });
