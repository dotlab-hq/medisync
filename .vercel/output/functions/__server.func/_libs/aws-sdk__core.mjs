...
import { r as requireCbor, a as requireSchema, b as requireProtocols$1, c as requireSerde, d as requireDistCjs$1 } from "./smithy__core.mjs";
import { r as require$$2 } from "./smithy__property-provider.mjs";
import { r as require$$4 } from "./smithy__signature-v4.mjs";
...
import { r as require$$7 } from "./aws-sdk__xml-builder.mjs";
var distCjs = {};
var client = {};
...
More information can be found at: https://a.co/c895JFp`);
  ...
  client.emitWarningIfUnsupportedVersion = emitWarningIfUnsupportedVersion;
  client.setCredentialFeature = setCredentialFeature;
  client.setFeature = setFeature;
  client.setTokenFeature = setTokenFeature;
  client.state = state;
  return client;
}
...
function requireDistCjs() {
  ...
  var propertyProvider = require$$2;
  var client2 = /* @__PURE__ */ requireClient();
  var signatureV4 = require$$4;
  var cbor = /* @__PURE__ */ requireCbor();
  var schema = /* @__PURE__ */ requireSchema();
  var smithyClient = require$$10;
  var protocols2 = /* @__PURE__ */ requireProtocols$1();
  var serde = /* @__PURE__ */ requireSerde();
  var utilBase64 = require$$5;
  var utilUtf8 = require$$6;
  var xmlBuilder = require$$7;
  const state = {
    warningEmitted: false
  };
  const emitWarningIfUnsupportedVersion = (version) => {
...
More information can be found at: https://a.co/c895JFp`);
  ...
  const getDateHeader = (response) => protocolHttp.HttpResponse.isInstance(response) ? response.headers?.date ?? response.headers?.Date : void 0;
  ...
  class JsonShapeDeserializer extends SerdeContextConfig {
    ...
    _read(schema$1, value) {
      ...
      if (ns.isTimestampSchema() && value != null) {
        const format = protocols2.determineTimestampFormat(ns, this.settings);
        switch (format) {
          case 5:
  ...
  class AwsJsonRpcProtocol extends protocols2.RpcProtocol {
    serializer;
    deserializer;
    serviceTarget;
    codec;
  ...
  class AwsRestJsonProtocol extends protocols2.HttpBindingProtocol {
    serializer;
    deserializer;
    codec;
    ...
    constructor({ defaultNamespace }) {
      ...
      this.serializer = new protocols2.HttpInterceptingShapeSerializer(this.codec.createSerializer(), settings);
      this.deserializer = new protocols2.HttpInterceptingShapeDeserializer(this.codec.createDeserializer(), settings);
    }
    getShapeId() {
  ...
  class XmlShapeDeserializer extends SerdeContextConfig {
    ...
    constructor(settings) {
      super();
      this.settings = settings;
      this.stringDeserializer = new protocols2.FromStringShapeDeserializer(settings);
    }
    setSerdeContext(serdeContext) {
      this.serdeContext = serdeContext;
  ...
  class QueryShapeSerializer extends SerdeContextConfig {
    ...
    writeKey(key) {
      ...
      this.buffer += `&${protocols2.extendedEncodeURIComponent(key)}=`;
    }
    writeValue(value) {
      this.buffer += protocols2.extendedEncodeURIComponent(value);
    }
  }
  class AwsQueryProtocol extends protocols2.RpcProtocol {
    options;
    serializer;
    deserializer;
    mixin = new ProtocolLib();
    ...
    async deserializeResponse(operationSchema, context, response) {
      ...
      if (response.statusCode >= 300) {
        const bytes2 = await protocols2.collectBody(response.body, context);
      ...
      const bytes = await protocols2.collectBody(response.body, context);
  ...
  class AwsRestXmlProtocol extends protocols2.HttpBindingProtocol {
    codec;
    serializer;
    deserializer;
    mixin = new ProtocolLib();
  ...
  distCjs.AWSSDKSigV4Signer = AWSSDKSigV4Signer;
  distCjs.AwsEc2QueryProtocol = AwsEc2QueryProtocol;
  distCjs.AwsJson1_0Protocol = AwsJson1_0Protocol;
  distCjs.AwsJson1_1Protocol = AwsJson1_1Protocol;
  distCjs.AwsJsonRpcProtocol = AwsJsonRpcProtocol;
  distCjs.AwsQueryProtocol = AwsQueryProtocol;
  distCjs.AwsRestJsonProtocol = AwsRestJsonProtocol;
  distCjs.AwsRestXmlProtocol = AwsRestXmlProtocol;
  distCjs.AwsSdkSigV4ASigner = AwsSdkSigV4ASigner;
  distCjs.AwsSdkSigV4Signer = AwsSdkSigV4Signer;
  distCjs.AwsSmithyRpcV2CborProtocol = AwsSmithyRpcV2CborProtocol;
  distCjs.JsonCodec = JsonCodec;
  distCjs.JsonShapeDeserializer = JsonShapeDeserializer;
  distCjs.JsonShapeSerializer = JsonShapeSerializer;
  distCjs.NODE_AUTH_SCHEME_PREFERENCE_OPTIONS = NODE_AUTH_SCHEME_PREFERENCE_OPTIONS;
  distCjs.NODE_SIGV4A_CONFIG_OPTIONS = NODE_SIGV4A_CONFIG_OPTIONS;
  distCjs.XmlCodec = XmlCodec;
  distCjs.XmlShapeDeserializer = XmlShapeDeserializer;
  distCjs.XmlShapeSerializer = XmlShapeSerializer;
  distCjs._toBool = _toBool;
  distCjs._toNum = _toNum;
  distCjs._toStr = _toStr;
  distCjs.awsExpectUnion = awsExpectUnion;
  distCjs.emitWarningIfUnsupportedVersion = emitWarningIfUnsupportedVersion;
  distCjs.getBearerTokenEnvKey = getBearerTokenEnvKey;
  distCjs.loadRestJsonErrorCode = loadRestJsonErrorCode;
  distCjs.loadRestXmlErrorCode = loadRestXmlErrorCode;
  distCjs.parseJsonBody = parseJsonBody;
  distCjs.parseJsonErrorBody = parseJsonErrorBody;
  distCjs.parseXmlBody = parseXmlBody;
  distCjs.parseXmlErrorBody = parseXmlErrorBody;
  distCjs.resolveAWSSDKSigV4Config = resolveAWSSDKSigV4Config;
  distCjs.resolveAwsSdkSigV4AConfig = resolveAwsSdkSigV4AConfig;
  distCjs.resolveAwsSdkSigV4Config = resolveAwsSdkSigV4Config;
  distCjs.setCredentialFeature = setCredentialFeature;
  distCjs.setFeature = setFeature;
  distCjs.setTokenFeature = setTokenFeature;
  distCjs.state = state;
  distCjs.validateSigningProperties = validateSigningProperties;
  return distCjs;
}
...
function requireProtocols() {
  ...
  var schema = /* @__PURE__ */ requireSchema();
  var smithyClient = require$$10;
  var protocols$1 = /* @__PURE__ */ requireProtocols$1();
  var serde = /* @__PURE__ */ requireSerde();
  var utilBase64 = require$$5;
  var utilUtf8 = require$$6;
  var xmlBuilder = require$$7;
  ...
  class JsonShapeDeserializer extends SerdeContextConfig {
    ...
    _read(schema$1, value) {
      ...
      if (ns.isTimestampSchema() && value != null) {
        const format = protocols$1.determineTimestampFormat(ns, this.settings);
        switch (format) {
          case 5:
            return serde.parseRfc3339DateTimeWithOffset(value);
          case 6:
  ...
  class AwsJsonRpcProtocol extends protocols$1.RpcProtocol {
    serializer;
    deserializer;
    serviceTarget;
    codec;
  ...
  class AwsRestJsonProtocol extends protocols$1.HttpBindingProtocol {
    serializer;
    deserializer;
    codec;
    mixin = new ProtocolLib();
    constructor({ defaultNamespace }) {
      ...
      this.codec = new JsonCodec(settings);
      this.serializer = new protocols$1.HttpInterceptingShapeSerializer(this.codec.createSerializer(), settings);
      this.deserializer = new protocols$1.HttpInterceptingShapeDeserializer(this.codec.createDeserializer(), settings);
    }
    getShapeId() {
      return "aws.protocols#restJson1";
    }
  ...
  class XmlShapeDeserializer extends SerdeContextConfig {
    ...
    constructor(settings) {
      super();
      this.settings = settings;
      this.stringDeserializer = new protocols$1.FromStringShapeDeserializer(settings);
    }
    setSerdeContext(serdeContext) {
      this.serdeContext = serdeContext;
      this.stringDeserializer.setSerdeContext(serdeContext);
  ...
  class QueryShapeSerializer extends SerdeContextConfig {
    ...
    writeKey(key) {
      ...
      this.buffer += `&${protocols$1.extendedEncodeURIComponent(key)}=`;
    }
    writeValue(value) {
      this.buffer += protocols$1.extendedEncodeURIComponent(value);
    }
  }
  class AwsQueryProtocol extends protocols$1.RpcProtocol {
    options;
    serializer;
    deserializer;
    mixin = new ProtocolLib();
    ...
    async deserializeResponse(operationSchema, context, response) {
      ...
      const dataObject = {};
      if (response.statusCode >= 300) {
        const bytes2 = await protocols$1.collectBody(response.body, context);
        if (bytes2.byteLength > 0) {
          Object.assign(dataObject, await deserializer.read(15, bytes2));
        }
        await this.handleError(operationSchema, context, response, dataObject, this.deserializeMetadata(response));
      ...
      const shortName = operationSchema.name.split("#")[1] ?? operationSchema.name;
      const awsQueryResultKey = ns.isStructSchema() && this.useNestedResult() ? shortName + "Result" : void 0;
      const bytes = await protocols$1.collectBody(response.body, context);
      if (bytes.byteLength > 0) {
        Object.assign(dataObject, await deserializer.read(ns, bytes, awsQueryResultKey));
      }
      const output = {
  ...
  class AwsRestXmlProtocol extends protocols$1.HttpBindingProtocol {
    codec;
    serializer;
    deserializer;
    mixin = new ProtocolLib();
  ...
  protocols.AwsEc2QueryProtocol = AwsEc2QueryProtocol;
  protocols.AwsJson1_0Protocol = AwsJson1_0Protocol;
  protocols.AwsJson1_1Protocol = AwsJson1_1Protocol;
  protocols.AwsJsonRpcProtocol = AwsJsonRpcProtocol;
  protocols.AwsQueryProtocol = AwsQueryProtocol;
  protocols.AwsRestJsonProtocol = AwsRestJsonProtocol;
  protocols.AwsRestXmlProtocol = AwsRestXmlProtocol;
  protocols.AwsSmithyRpcV2CborProtocol = AwsSmithyRpcV2CborProtocol;
  protocols.JsonCodec = JsonCodec;
  protocols.JsonShapeDeserializer = JsonShapeDeserializer;
  protocols.JsonShapeSerializer = JsonShapeSerializer;
  protocols.XmlCodec = XmlCodec;
  protocols.XmlShapeDeserializer = XmlShapeDeserializer;
  protocols.XmlShapeSerializer = XmlShapeSerializer;
  protocols._toBool = _toBool;
  protocols._toNum = _toNum;
  protocols._toStr = _toStr;
  protocols.awsExpectUnion = awsExpectUnion;
  protocols.loadRestJsonErrorCode = loadRestJsonErrorCode;
  protocols.loadRestXmlErrorCode = loadRestXmlErrorCode;
  protocols.parseJsonBody = parseJsonBody;
  protocols.parseJsonErrorBody = parseJsonErrorBody;
  protocols.parseXmlBody = parseXmlBody;
  protocols.parseXmlErrorBody = parseXmlErrorBody;
  return protocols;
}
var protocolsExports = /* @__PURE__ */ requireProtocols();
export {
  requireProtocols as a,
  requireClient as b,
  clientExports as c,
  distCjsExports as d,
