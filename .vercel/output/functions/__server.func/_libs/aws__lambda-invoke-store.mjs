var invokeStore = {};
var hasRequiredInvokeStore;
function requireInvokeStore() {
  if (hasRequiredInvokeStore) return invokeStore;
  hasRequiredInvokeStore = 1;
  (function(exports$1) {
    ...
    })(exports$1.InvokeStore || (exports$1.InvokeStore = {}));
    exports$1.InvokeStoreBase = InvokeStoreBase;
  })(invokeStore);
  return invokeStore;
}
var invokeStoreExports = /* @__PURE__ */ requireInvokeStore();
export {
  invokeStoreExports as i
};
