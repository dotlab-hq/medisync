...
const FolderPlus = createLucideIcon("folder-plus", __iconNode$x);
const __iconNode$w = [
  [
    "path",
    {
...
const Hospital = createLucideIcon("hospital", __iconNode$r);
const __iconNode$q = [
...
const Map = createLucideIcon("map", __iconNode$i);
const __iconNode$h = [
...
const OctagonX = createLucideIcon("octagon-x", __iconNode$f);
const __iconNode$e = [
  [
    "path",
    {
