import { c as commonjsGlobal, d as getAugmentedNamespace, g as getDefaultExportFromCjs } from "./react.mjs";
...
function requireTypeOverrides() {
  ...
  const types = /* @__PURE__ */ requirePgTypes();
...
function requireConnection() {
  ...
  const { parse, serialize } = /* @__PURE__ */ requireDist();
...
function requireClient$1() {
  ...
  const TypeOverrides = /* @__PURE__ */ requireTypeOverrides();
  const ConnectionParameters = /* @__PURE__ */ requireConnectionParameters();
  const Query = /* @__PURE__ */ requireQuery$1();
  const defaults2 = /* @__PURE__ */ requireDefaults();
...
function requireLib() {
  ...
  hasRequiredLib = 1;
  (function(module) {
    const Client = /* @__PURE__ */ requireClient$1();
    const defaults2 = /* @__PURE__ */ requireDefaults();
    const Connection = /* @__PURE__ */ requireConnection();
    const Result = /* @__PURE__ */ requireResult();
    const utils2 = /* @__PURE__ */ requireUtils$1();
    const Pool = /* @__PURE__ */ requirePgPool();
    const TypeOverrides = /* @__PURE__ */ requireTypeOverrides();
    const { DatabaseError } = /* @__PURE__ */ requireDist();
    const { escapeIdentifier, escapeLiteral } = /* @__PURE__ */ requireUtils$1();
    ...
    if (forceNative) {
      clientConstructor = /* @__PURE__ */ requireNative();
    }
