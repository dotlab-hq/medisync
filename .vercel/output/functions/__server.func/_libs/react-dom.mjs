...
function requireReactDomServer_bun_production() {
  ...
  if ("19.2.4" !== isomorphicReactPackageVersion$jscomp$inline_821)
    throw Error(
  ...
  reactDomServer_bun_production.version = "19.2.4";
...
function requireReactDomServerLegacy_browser_production() {
  ...
  var React = /* @__PURE__ */ requireReact(), ReactDOM2 = /* @__PURE__ */ requireReactDom();
  function formatProdErrorMessage(code) {
    var url = "https://react.dev/errors/" + code;
    if (1 < arguments.length) {
      url += "?args[]=" + encodeURIComponent(arguments[1]);
...
function requireServer_bun() {
  ...
  var l;
  {
    b = /* @__PURE__ */ requireReactDomServer_bun_production();
...
var server_bunExports = /* @__PURE__ */ requireServer_bun();
