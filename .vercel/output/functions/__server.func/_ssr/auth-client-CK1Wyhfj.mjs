import { g as getBaseURL, f as createFetch, h as defu, i as capitalizeFirstLetter } from "./server-Cw4QVuYO.mjs";
...
const getClientConfig = (options, loadEnv) => {
  ...
  const baseURL = getBaseURL(options?.baseURL, options?.basePath, void 0) ?? resolvePublicAuthUrl() ?? "/api/auth";
