...
import { d as defineLazyEventHandler, a as H3Core } from "./_libs/h3.mjs";
...
const _lazy_w3cd3D = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
const findRoute = /* @__PURE__ */ (() => {
  const data = { route: "/**", handler: _lazy_w3cd3D };
  return ((_m, p) => {
